    ...
    while cap.isOpened():
        ...
        try:
            ...
            if landmarks:
                ...
                draw_text(image, str(bicep_curl_angle), tuple(np.multiply(elbow, [640, 480]).astype(int)),
                ...
                draw_text(image, str(squat_angle), tuple(np.multiply(knee, [640, 480]).astype(int)),
                          font_scale=0.5, color=(255, 255, 255), thickness=2)
